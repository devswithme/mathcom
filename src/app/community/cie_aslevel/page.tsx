...
export default function CIEASLevelCommunity() {
  ...
  const COMMUNITY_NAME = "CIE AS Level";
    ...
    <main className='flex flex-col'>
      ...
      <div className="pb-5">
        <div className="flex justify-between px-4">
          <div>
            <h1 className="text-3xl font-bold">m/cie_aslevel</h1>
            <p className="text-sm text-muted-foreground mt-1">
              A space for Cambridge AS Level students to ask math questions, share tips, and support one another.
            </p>
          </div>
