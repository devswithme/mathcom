...
export default function CIEA2LevelCommunity() {
  ...
  const COMMUNITY_NAME = "CIE A2 Level";
    ...
    <main className='flex flex-col'>
      ...
      <div className="pb-5">
        <div className="flex justify-between px-4">
          <div>
            <h1 className="text-3xl font-bold">m/cie_a2level</h1>
            <p className="text-sm text-muted-foreground mt-1">
              A space for Cambridge A2 Level students to ask math questions, share tips, and support one another.
            </p>
          </div>
